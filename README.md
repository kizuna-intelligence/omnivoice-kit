...
つくよみちゃん寄りの学習済みモデル、デモ、アプリを公開・配布するときは、利用先の公開形態に応じてクレジットや利用条件を確認してください。
...
- つくよみちゃんコーパスそのものを学習に使う場合の可否や条件は、別途つくよみちゃん側の規約を個別に確認してください
- モデル利用時のクレジットと、学習時の規約確認は別の話として扱ってください
